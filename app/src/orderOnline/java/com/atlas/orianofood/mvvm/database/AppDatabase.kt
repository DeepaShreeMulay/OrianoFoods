...
@Database(
    entities = [LoginData::class, UserData::class, CategoryItem::class, TopRatedItem::class, SellingItem::class, GalleryItem::class,TopCategoryItem::class,ProfileItems::class],
    version = 2,
    exportSchema = false
)
